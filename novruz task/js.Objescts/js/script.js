...
let studentCount = [];
//let x = document.getElementsByClassName("form-control").value;
...
let Cvalue = document.getElementById('choose').value;

vlueArray.push(Cvalue);
...
let  teacherCount = document.getElementById('tCount');
...
let groupValue = document.getElementById('choose2').value;

groupvalueArray.push(groupValue);

teacherCountArray.push(Tname);

teacherCount.innerHTML = teacherCountArray.length;
